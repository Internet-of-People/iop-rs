...
rm -rf pkg/
wasm-pack build --release --target browser --out-dir pkg/browser --out-name iop_coeus_core_wasm
wasm-pack build --release --target nodejs --out-dir pkg/node --out-name iop_coeus_core_wasm
